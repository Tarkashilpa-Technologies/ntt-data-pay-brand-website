...
export default function mGalla() {
  return (
    <div className="product-payment pd-lr-15">
      <Head>
        <title>
          mGalla -Best payment app for Business and Merchants|NTT DATA Payment
          Services India
        </title>
        <meta
          name="description"
          content="NTT DATA Payment Services India offers the best payment app for businesses. With mGalla, you can collect payments digitally through Bharat QR, mPOS, UPI and Link-based payments. Quick sign up with no setup cost. Accept payments anytime, anywhere through your mobile."
        />
        <link
          rel="canonical"
          href="https://www.nttdatapay.com/mgalla-payment-app"
        />
        <script
      ...
      <div className="bnr-home-wrp product-mgalla-bnr">
        <div className="container_1300">
          <div className="bnr-caption">
            ...
            <p>
              Empower your business with mGalla-the best payment app for small
              business and receive payments anytime, anywhere through your
              mobile!{" "}
            </p>
            <Link href="/sign-up">
          ...
          <div className="row">
            <div className="col-md-6">
              <div className="boost-lhs-wrp">
                <h2 className="common-ttle">
                  Get started with mGalla in just 4 easy steps!
                </h2>
                <p className="common-desc">
                  The mGalla app is a payment app for merchants that will end
                  all your payment issues. Suited for all business types, you
                  can start collecting payments after one-time signup and at no
                  additional costs.{" "}
                </p>
                    ...
                    <SwiperSlide>
                      <div className="row">
                        ...
                        <div className="col-md-6">
                          <div className="boost-card">
                            <img
                              src="/images/mgalla-icn-8.svg"
                              alt=""
                              className="img-fluid"
                            />
                            <h3>
                              Scan a copy of your Pan Card or Aadhaar Card
                            </h3>
                          </div>
                        </div>
                        <div className="col-md-6">
                          <div className="boost-card">
                            <img
                              src="/images/mgalla-icn-9.svg"
                              alt=""
                              className="img-fluid"
                            />
                            <h3>Wait for an OTP for verification</h3>
                            <p>
                              Make online transactions and pay offline at any
                              bank branch across India, saving time & money.
                            </p>
                          </div>
                        </div>
                      </div>
            ...
            <div className="col-md-6">
              <div className="boost-rhs-wrp">
                <img
                  src="/images/mgalla-send-fld-illust.svg"
                  alt="payment–app-for-small-business"
                  className="img-fluid"
                />
              </div>
            </div>
      ...
      <div className="product-feature-wrp">
        <div className="container_1300 d-block">
          <h2 className="common-ttle white-clr text-center">
            A feature rich app for all your payment acceptance woes
          </h2>
            ...
            <div className="row">
              <div className="col-md-4">
                <div className="feat-card">
                  <img
                    src="/images/mgalla-icn-1.svg"
                    alt=""
                    className="img-fluid"
                  />
                  <p className="ttle">
                    Instant Activation with minimal documentation
                  </p>
                  <p className="desc">
                    As the best payment app for small business, your KYC
                    activation involves only two steps. You can initiate the
                    mGalla payment app for merchants by providing basic details
                    like your name, number, address, and PAN and start accepting
                    payments instantly.
                  </p>
                </div>
              </div>
              <div className="col-md-4">
                <div className="feat-card">
                  <img
                    src="/images/mgalla-icn-2.svg"
                    alt=""
                    className="img-fluid"
                  />
                  <p className="ttle">Innovative Payment Options</p>
                  <p className="desc">
                    mGalla is one of the best mobile payment apps for merchants
                    that offers all the major payment options, including UPI,
                    Payment Links, Bharat QR, and mPOS.{" "}
                  </p>
                </div>
              </div>
              <div className="col-md-4">
                <div className="feat-card">
                  <img
                    src="/images/mgalla-icn-3.svg"
                    alt=""
                    className="img-fluid"
                  />
                  <p className="ttle">Convenient for Customers</p>
                  <p className="desc">
                    Provide your customers with the convenience of making
                    payment to you through any mobile banking application that
                    they have.{" "}
                  </p>
                </div>
              </div>
              ...
              <div className="col-md-4">
                <div className="feat-card">
                  <img
                    src="/images/mgalla-icn-4.svg"
                    alt=""
                    className="img-fluid"
                  />
                  <p className="ttle">Track and manage your payments</p>
                  <p className="desc">
                    Keep a close track of your payments and manage your refunds
                    with mGalla- Payment application for Merchants.
                  </p>
                </div>
              </div>
              ...
              <div className="col-md-4">
                <div className="feat-card">
                  <img
                    src="/images/mgalla-icn-5.svg"
                    alt=""
                    className="img-fluid"
                  />
                  <p className="ttle">World-Class Security</p>
                  <p className="desc">
                    3.2 V PCI-DSS compliance to secure all data & transactions
                    along with 128 bit SSL encryption.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="row">
            <div className="col-md-5">
              <div className="exp-lhs">
                <h2 className="common-ttle">
                  Make your smartphone the powerhouse of digital payment
                  acceptance modes
                </h2>
              ...
              <div className="feat-main-wrp">
                <div className="row">
                  <div className="col-md-6">
                    <div className="feat-card">
                      ...
                      <p className="desc  text-black">
                        Send a payment link to your customers over WhatsApp, SMS
                        or e-mail and get paid instantly.
                      </p>
                    </div>
                  </div>
                  <div className="col-md-6">
                    <div className="feat-card">
                      ...
                      <p className="desc  text-black">
                        Allow your customers to pay you with a simple scan
                        through any bank application with Bharat QR.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="col-md-6">
                    <div className="feat-card">
                      <img
                        src="/images/mgalla-icn-10.svg"
                        alt=""
                        className="img-fluid"
                      />
                      <p className="ttle  text-black">UPI</p>
                      <p className="desc  text-black">
                        Accept payments in one click from your customers over a
                        VPA with UPI, eliminating sharing any bank details
                      </p>
                    </div>
                  </div>
                  <div className="col-md-6">
                    <div className="feat-card">
                      <img
                        src="/images/mgalla-icn-11.svg"
                        alt=""
                        className="img-fluid"
                      />
                      <p className="ttle  text-black">mPOS</p>
                      <p className="desc  text-black">
                        Accept card payments in-store or on the go with NTT DATA
                        Payments’ compact yet agile mPOS device.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="col-md-6">
                    <div className="feat-card">
                      <img
                        src="/images/mgalla-icn-12.svg"
                        alt=""
                        className="img-fluid"
                      />
                      <p className="ttle  text-black">Cash</p>
                      <p className="desc  text-black">
                        Keep a tab of your incoming cash payments with mGalla’s
                        cash option and manage your inventory effortlessly.
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <div className="explore-other-wrp exp-wrp">
        <div className="container_1100 d-block">
          <div className="row">
            <div className="col-md-12 text-center">
              <h2 className="common-ttle">
                Kickstart your digital payment acceptance journey with the best
                online payment app for businesses.
              </h2>
              <Link href="/sign-up">
                <a href="" className="btn_style1">
                  <p>Sign up</p>
              ...
              <div className="faq-rhs">
                <div className="accordion" id="accordionExample3">
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                        mGalla is a completely free payment app For small
                        businesses. Downloading and signing up with the
                        application involves no charges whatsoever.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                        mGalla is a free and one of the best online payment apps
                        for small businesses. Downloading and signing up with
                        the application involves no charges whatsoever.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="accordion-item">
                    <p className="accordion-header" id="headingOne3">
                      <button
                        ...
                        aria-controls="collapseOne3"
                      >
                        How is mGalla different from other digital payment
                        applications?
                      </button>
                    </p>
                    <div
                    ...
                    >
                      <div className="accordion-body">
                        With this era of digitization, it is crucial for any
                        business, which wants to prosper, to accept the digital
                        form of payments. mGalla is a free application providing
                        you with a range of digital payment options at your
                        fingertips. It is extremely convenient, easily
                        accessible and provides a seamless experience of
                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                        Download mGalla App from Google Playstore or get in
                        touch with our customer service centre where our
                        executive will provide you with a download link through
                        SMS. Once you have downloaded the app, put in all the
                        relevant information required. This is going to be so
                        simple that it wouldn&#39;t even take 5 minutes of your
                        time.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                        Yes. When you opt for Sign Up you are provided with two
                        options. You can either Sign Up as an Individual or as a
                        Corporate.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                        You are simply required to put up a scanned copy of
                        either a PAN card or an Aadhaar Card to move on.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                        No, you are only required to scan the desired document
                        through the Payment App For small business. You do not
                        have to send or courier any documents to us.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                        If you do not have a PAN card, you can scan your Aadhaar
                        card for verification purposes. We do not require both
                        of your documents.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                        Yes, it is compulsory for you to scan either your PAN or
                        Aadhaar Card for verification purposes in the best
                        online payment app for small business.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                        mGalla is a highly secured payment app for merchants. We
                        understand that you trust us with your money and so, we
                        are here to provide you with bank-level security
                        features. NTT DATA Payment Services is PCI DSS v. 3.2.1
                        and SSL 256 bit encrypted, which is the highest level of
                        security available.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                        mGalla, the best mobile payment apps for small
                        businesses requires your phone to have an android
                        version of 4.0.3 and above. This is the most basic
                        android version and will definitely be compatible with
                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                        Currently, we have more than 50,000 merchants who have
                        collaborated with mGalla, payment apps for business.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="accordion-item">
                    <p className="accordion-header" id="headingOne13">
                      <button
                        ...
                        aria-controls="collapseOne3"
                      >
                        Does my customer need to have mGalla application to pay
                        me?
                      </button>
                    </p>
                    <div
                    ...
                    >
                      <div className="accordion-body">
                        No, your customer can pay using their existing bank
                        application without having to download mGalla, the best
                        online payment app for small business.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                        You are instantly onboarded with mGalla as soon as you
                        download the application, complete the registration and
                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                        As soon as you complete the Sign Up process with the
                        payment apps for business, you can start collecting
                        digital payments through mGalla. You can submit your KYC
                        whenever you decide to get the amount settled in your
                        bank account.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                        In case you switch your mobile number and need to update
                        it on mGalla, the payment app for merchants, you have to
                        get in touch with our customer care executive and they
