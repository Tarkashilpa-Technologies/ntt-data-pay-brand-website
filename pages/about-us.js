...
export default function About() {
  return (
    <div className="aboutpage">
      <Head>
        <title>
          NTT DATA Payment Services India Ltd.- formerly Atom Technologies |
          Leading Payment Gateway Company in India
        </title>
        <meta
          name="description"
      ...
      <div className="bnr-home-wrp bnr-about-wrp">
        <div className="container_1100">
          <div className="bnr-caption">
            <h2>
              Hello,
              <br /> we are NTT DATA Payment Services
            </h2>
            <p>
              We help people around the world accept payments to boost their
              businesses.
            </p>
            <Link href="/sign-up">
        ...
        <div className="container_1100">
          <div className="row">
            <div className="col-md-6">
              <p className="about-service-heading common-ttle">
                NTT DATA Payment Services- Asia&#39;s leading digital payment
                service provider
              </p>
            </div>
            <div className="col-md-6">
              <p className="common-desc">
                NTT DATA Payment Services India is constantly marvelling in
                providing secure and seamless digital payment solutions across
                various industrial and banking segments across the globe. NTT
                DATA Payment Services India caters to more than 6 million+
                merchants, with an annual transaction value and volume of INR
                800+ billion and 100 million, respectively.
              </p>
              <p className="common-desc">
                NTT DATA Payment Services complies with PCI DSS 3.2.1V and is
                256-bit encrypted, keeping our security system bulletproof.
              </p>
              <p className="common-desc">
                In 2019, NTT DATA, a Japanese system integration company
                acquired Atom Technologies, now known as NTT DATA Payment
                Services India. As one of the global innovators, NTT DATA has
                been striving to establish a framework through which it can
                provide its diverse services worldwide and support its
                customers&#39; needs and further broaden the horizon for
                customers in both Indian and Global Market
              </p>
            </div>
          </div>
          ...
          <div className="row padding-top-118 ">
            <div className="col-md-6">
              <p className="about-service-heading common-ttle padding-top-90 padding-bottom-60">
                NTT DATA Payment Services&#39;
                <br /> 360 degrees payment
                <br /> solution
              </p>
              <p className="common-desc">
                Providing secured and seamless payment solutions, NTT DATA
                Payments&#39; services encompasses Online Payment Gateway, Card
                Swipe Machine, IVR, Merchant Mobile Application and various,
                white-labelled solutions for the banks. With over 100 payment
                options, our merchants are armed to collect online, offline, and
                contactless payments anytime, anywhere. NTT DATA Payments also
                equips you to track payments on a real-time basis with our
                robust Merchant console.
              </p>
            </div>
            <div className="col-md-6">
      ...
      <div className="about-global-connectivity min-height-800">
        <div className="container_1100">
          <div className="row">
            <div className="col-md-6">
              <p className="common-ttle padding-bottom-50 text-white padding-top-100">
                NTT DATA and its Global Connectivity
              </p>
              <p className="common-desc text-white">
                NTT DATA is a conglomerate with more than 1,30,000 professionals
                working across 50+ countries, including Japan, China, the USA,
                Canada, South Korea, Thailand, Singapore, and many more.
              </p>
              <p className="common-desc text-white">
                NTT DATA operates Japan’s largest card payment processing
                network, CAFIS. NTT DATA has been leading the payment industry
                for over 30 years through CAFIS. Their aim is to make purchasing
                a lot more convenient and enjoyable for everyone.
              </p>
            </div>
            <div className="col-md-6 position-relative  min-height-800">
              <div className="global-connectivity-box  about-bg-purple">
                <p className="common-desc text-white m-0">
                  Speaking in numbers, NTT DATA has been highly stable and
                  reliable for over 35 years, with over 22 billion dollars in
                  revenue. It provides multiple payment solutions for banks and
                  merchants through innovative services like mobile payments,
                  contactless payments, loyalty, & ticketing.{" "}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              <div className="about-payment-services-text">
                ...
                <p className="common-desc">
                  NTT DATA Global Payment Services is a global payment innovator
                  that helps local and global merchants manage local and
                  cross-border transactions in multiple currencies for their
                  online and offline business through a single platform.
                </p>
                <p className="common-desc">
                  Our wide range of payment services and solutions we offer to
                  e-commerce, retailers, travel agencies, hotels, financial
                  institutions, airlines and many more, are customisable
          ...
          <div className="row">
            <div className="col-md-6">
              <div className="about-mission-vision about-mission bg-white">
                ...
                <p className="common-desc grey-text">
                  Produce customer centric and state-of-the-art payment services
                  to enhance our clients’ business capabilities.
                </p>
                <p className="common-desc grey-text">
                  Create a safer and more efficient digital payment platform in
                  the society through our expertise
                </p>
              </div>
            </div>
            <div className="col-md-6">
              <div className="about-mission-vision about-vision  bg-white">
                ...
                <p className="mission-vision-bold-text">
                  Trusted Payment Innovator
                </p>
              </div>
            </div>
          </div>
            ...
            >
              <SwiperSlide>
                <div className="journo-card">
                  <h2>2022</h2>
                  <p>
                    NTT DATA acquires major stake, leading to a complete rebrand
                    of Atom Technologies into NTT DATA Payment Services India
                    Limited.
                  </p>
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className="journo-card">
                  <h2>2019</h2>
                  <p>
                    Atom Technologies, officially an NTT DATA Company,
                    post-acquisition by the corporate giant.
                  </p>
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className="journo-card">
                  <h2>2018</h2>
                  <p>
                    NTT DATA, a leading IT services provider headquartered in
                    Tokyo, announced that it has entered into an agreement to
                    acquire a majority stake in Atom Technologies.
                  </p>
                </div>
              </SwiperSlide>
              {/* <SwiperSlide>
                <div className="journo-card">
                  <h2>2017</h2>
                  <p>
                    Launched mGalla- Payment app for merchants enabling digital
              ...
              <SwiperSlide>
                <div className="journo-card">
                  <h2>2016</h2>
                  <p>
                    Tied up with IRCTC. Also, incorporated Bharat QR Code as a
                    payment option.
                  </p>
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className="journo-card">
                  <h2>2015</h2>
                  <p>
                    Launched a semi-closed Prepaid card in India and mobile
                    wallet for corporates and individuals.
                  </p>
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className="journo-card">
                  <h2>2014</h2>
                  <p>
                    Reached a milestone of 10,000 POS installations across
                    India.
                  </p>
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className="journo-card">
                  <h2>2013</h2>
                  <p>
                    Partnered with leading international PSP for payment
                    services.
                  </p>
              ...
              <SwiperSlide>
                <div className="journo-card">
                  <h2>2012</h2>
                  <p>
                    Launched Internet Payment Gateway/ NetBanking solutions for
                    merchants and Mobile Banking white-labelled application for
                    banks
                  </p>
                </div>
              </SwiperSlide>
              ...
              <SwiperSlide>
                <div className="journo-card">
                  <h2>2009</h2>
                  <p>
                    Launched its Mobile App- the organization’s mobile payment
                    solution.
                  </p>
              ...
              <SwiperSlide>
                <div className="journo-card">
                  <h2>2008</h2>
                  <p>
                    Launched Interactive Voice Response (IVR) payments system
                  </p>
                </div>
              </SwiperSlide>
              <SwiperSlide>
      ...
      <div className="our-team padding-top-120">
        <div className="container_1100">
          <h2 className="common-ttle text-center padding-bottom-50">
            Meet our Management
          </h2>
        ...
        <div className="modal-dialog modal-dialog-centered modal-lg">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <p className="common-desc">
                Takeo Ueno takes a vision and makes it reality through sound
                strategy development. He intuitively sees the threads of
                opportunity that wind through an organization, brings them
                together into a coherent whole, helps others extend their
                thinking, and drives material business advantage. He is an
                inspirational individual who tells stories that inspire action
                while at the same time is grounded in information that levers
                the business.
              </p>
            </div>
          </div>
      ...
      >
        <div className="modal-dialog modal-dialog-centered modal-lg">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <p className="common-desc">
                Rahul Jain became an indispensable asset to our organization in
                October 2019 as its Chief Financial Officer (CFO). Originally,
                he was associated with the Merger and Acquisition team of NTT
                DATA, which involved evaluating Fintech companies in India and
                was one of the key members of the team which was actively
                involved in the acquisition of Atom by NTT DATA. He assumed
                various leadership positions during his tenure of almost 2
                decades with NTT DATA. As an established finance leader, Rahul
                has extensive and rich global experience in Value Creation,
                Corporate Governance, Business Partnering, Mergers and
                Acquisitions, Cost Management, IT Implementations, Outsourcing,
        ...
        <div className="modal-dialog modal-dialog-centered modal-lg">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <p className="common-desc">
                ASM has more than 18 years of experience in cards, payment
                operations, authorization, issuance, risk &amp; compliance with
                major banks in India. In his current role, he is responsible for
                the Risk &amp; Compliance function for Pre-Post enrolment,
                Compliance function, Dispute management for POS &amp; e-com. He
                has been with us since 2013. ASM loves listening to music and
                enjoys the company of a good book.
              </p>
            </div>
          </div>
        </div>
      ...
      >
        <div className="modal-dialog modal-dialog-centered modal-lg">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <p className="common-desc">
                Vivek has more than 20 years of hands-on experience in sales,
                pre-sales, and solution ideation in the Payments domain with
                competencies and expertise in Merchant Acquiring and Operations
                including specific focus on business development and cross
                selling in Domestic Markets. Vivek loves socializing and is a
                travel junkie.
              </p>
            </div>
          </div>
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              <p className="common-desc">
                ...
                building and nurturing relationship and servicing clients in the
                Education and Government Sector, across South-West India. Prior
                his association with NTT DATA Payment Services, Rajasekhar has a
                diverse and encompassing work history of pursuing leads and
                driving sales for corporate giants like ICICI Bank, American
                Express and Worldline. As a payment industry expert in POS and
