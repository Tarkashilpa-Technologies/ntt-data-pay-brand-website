            ...
            <div style={{ flex: 1 }}>
              <div className="d-flex w-100 h-100">
                          ...
                          >
                            <button
                              ...
                              onClick={() => {
                                ...
                                router.push(
                                  `/api-reference-screen/${dropdown?.attributes?.Title.toLowerCase().replace(
                                    /\s+/g,
                                    "-"
                                  )}`
                                );
                ...
                <div className="h-100 w-lg-50 w-100">
                  <div
                    className="p-xl-5 pt-xl-2 pt-lg-2 middle-section-shadow"
                    style={{ maxHeight: fullHeight - 135 }}
                  >
                    <div className="text-start">
                      ...
                      {apiData?.attributes?.Defination?.info
                        ?.termsOfService && (
                        <div className="pt-3">
