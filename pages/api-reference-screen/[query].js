      ...
      {fullHeight && isReady ? (
        <div className="d-flex flex-column w-100">
          ...
          <div className="d-flex w-100">
            <div className="bg-primary overflow-y-auto first-section-width d-lg-block d-none">
              <div>
                {apisListData?.map((dropdown, index) => {
                  return (
                    <div key={index}>
            ...
            <div className="h-100 w-lg-50 w-100">
              <div
                className="px-xl-5 pt-xl-2 pt-lg-2 middle-section-shadow"
            ...
            <div
              ...
              style={{ width: 400, height: fullHeight- 84 }}
            >
