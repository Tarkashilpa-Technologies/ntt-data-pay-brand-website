...
<h2 className="common-ttle">Boost your business<br/> with all major payment options<br/> and much more</h2>  
...
<div className="row">
  <div className="col-md-6">
   <div className="smooth-lhs">
     <h2 className="common-ttle white-clr">Smoother, Quicker integrations over web and mobile</h2>
...
<div className="row">
 <div className="col-md-8">
  <div className="intell-lhs">
    <h2 className="common-ttle">Use intelligent data to scale<br/> faster, boost conversions, and<br/> capture revenue.</h2>
...
<div className="ppo-grid-cvr">
 <div className="row g-0">
  ...
  <h2 className="ttle">24*7 uninterrupted account validation</h2>
...
your disposal for every kind of online & offline payment.</p>
  ...
  <h2 className="ttle white-clr">Low reversals and failed transfers</h2>
  ...
  <h2 className="ttle">Minimizing risk & fraudulent transactions</h2>
...
PCI DSS 3.2.1v complied payment system.</p>
  ...
  <h2 className="ttle">Updating refund balance through the online console</h2>
