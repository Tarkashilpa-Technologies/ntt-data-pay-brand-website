  ...
  return (
    <div className="product-payment pd-lr-15">
      <Head>
        ...
        <meta name="description" content="NTT DATA Payment Services support team is here to assist your business growth. Get answers to all your queries related to NTT DATA Payment Services." />
  ...
  /> 
    ...
    <div className="container_1300">
     <div className="bnr-caption">
       ...
       <p>NTT DATA Payment Services assures a sincere and transparent approach
to all its customers. The policy aims at offering optimum support in case of any
customer grievances or complaints.</p>
      
       <a href="https://nttdatapay.freshdesk.com/support/tickets/new" target="_blank" rel="noopener noreferrer"   className='btn_style1'>Raise a ticket</a>
...
<div className="container_1300 d-block">
  ...
  <li className="breadcrumb-item"><Link href="/"><a >Home</a></Link></li>
    <li className="breadcrumb-item active" aria-current="page">Customer Care</li>
  </ol>
</div>
</nav>
...
<div className="expectation-inner">
 <h2 className='common-ttle'>If we fall short of your expectations, 
let us know!</h2>   
...
<div className="psp-top-cvr">
 <h2 className='common-ttle text-center white-clr'>NTT DATA Payment Services policy <br/>
on Grievance redressal</h2>
 <p className="common-desc white-clr text-center">We understand that customer grievances can happen due to multiple reasons. It can be because of the gap between the promised service levels and the service levels offered and due to the genuine technical or communicative errors in the system. Users are 
informed about the channels to escalate their complaints, concerns and grievances within NTT DATA Payment Services and their rights if they are not satisfied with the resolution of their complaints.</p>   
</div>
...
<div className="row">
 <div className="col-md-6">
  <div className="psp-lhs">
    <ul>
     <li>Concerns raised by users are dealt with courtesy in a timely manner.</li>
     <li>We constantly endeavour to give and uphold the best of the services we can offer</li>
     <li>We take care of all complaints efficiently and fairly.</li>
     <li>All employees at NTT DATA Payment Services works in good faith and without prejudice to the interests of the users</li>   
    </ul>
  </div>   
 </div>
 <div className="col-md-6">
...
<div className="tab-content" id="myTabContent">
  ...
  <div className="cds-tab-desc">
     ...
     <div className="col-md-8">   
     <input type="text" onChange={(e)=>{setTid1(e.target.value)}} name='tid1' className="form-control textbox" required id="tid1" />   
     </div>
     <div className="col-md-4">
     <button type="submit" className="btn btn-primary btn_style1" onClick={(e)=>{handleSubmit1(e)}}>Submit</button>
     </div>
     </form>
    </div> 
  ...
  <div className="col-md-4">
   ...
   <img src="/images/cs-pos-paper-roll.svg" alt="" className="img-fluid" />  
    </div> 
  </div>
</div>
  ...
  <div className="cds-tab-desc">
     ...
     <form action="" className="row">
     <div className="col-md-8">   
     <input type="text" onChange={(e)=>{setTid2(e.target.value)}} name='tid2' className="form-control textbox" required id="tid2" />   
     </div>
     <div className="col-md-4">
     <button type="submit" className="btn btn-primary btn_style1"  onClick={(e)=>{handleSubmit2(e)}}>Submit</button>
     </div>
     </form>
    </div> 
  ...
  <div className="col-md-4">
   <div className="cds-rhs-pic text-center">
   <img src="/images/cs-edc-machine-related.svg" alt="" className="img-fluid" />  
    </div> 
  </div>
</div>
...
<div className="row align-items-center">
  ...
  <div className="cds-tab-desc">
     ...
     <form action="" className="row">
     <div className="col-md-8">   
     <input type="text" onChange={(e)=>{setTid3(e.target.value)}} name='tid3' className="form-control textbox" required id="tid3" />   
     </div>
     <div className="col-md-4">
     <button type="submit" className="btn btn-primary btn_style1"  onClick={(e)=>{handleSubmit3(e)}}>Submit</button>
     </div>
     </form>
    </div> 
  ...
  <div className="col-md-4">
   <div className="cds-rhs-pic text-center">
   <img src="/images/cs-required-training.svg" alt="" className="img-fluid" />  
    </div> 
  </div>
</div>
...
<h2 className='common-ttle text-center white-clr'>Grievance Redressal</h2>
...
<div className="container_1300 d-block">
<h2 className="common-ttle text-center">Frequently Asked Questions</h2>     
