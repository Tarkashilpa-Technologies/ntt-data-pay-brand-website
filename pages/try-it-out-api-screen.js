...
const TryItOutApiScreen = () => {
  ...
  async function handleSendRequestClick(e) {
    ...
    if (!showError) {
      try {
        const promise1 = setResponse(null);
        ...
        Promise?.all([promise1, promise2]).then(() => {
          try {
            var responseObj = JSON.parse(JSON.stringify(res?.data));
            ...
            if (typeof responseObj === "object") {
              ...
              if (responseObj?.message === "Success" && responseObj?.data) {
              ...
              setResponse(responseObj?.toString());
            }
          } catch {
                    ...
                    <div className="w-100 api-explorer-page-size">
                      ...
                      <div className="py-2 w-100">
                        ...
                        <div className="text-white d-flex flex-column justify-content-center  w-100 w-md-50  position-relative">
                          ...
                          >
                            <span
                              class={`pe-3 ${copyText ? "tooltiptext" : ""}`}
                              id="myTooltip"
                            >
