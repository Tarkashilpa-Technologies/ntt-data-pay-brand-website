      ...
      <div className="bnr-home-wrp integration-guide-main-bnr">
        <div className="container_1300">
          <div className="bnr-caption">
            <h2>
              Hassle free guides for a quick and seamless Payment Gateway
              Integration
            </h2>
          </div>
        </div>
            ...
            <div className="ig-f2-lhs">
              ...
              >
                ...
                <button
                  ...
                  aria-selected="false"
                >
                  Settlement Account Add/Update APIs
                </button>
              </div>
            </div>
          </div>
            ...
            <div className="ig-f2-rhs">
              <div className="tab-content" id="v-pills-tabContent">
                ...
                >
                  ...
                  <h4>Overview: </h4>
                  <p>
                    Invoice payment link API module enables you to perform
                    various actions pertaining to invoice generation to accept
                    payments via payment link as an API-based alternative for
                    the same actions performed using the Console.
                  </p>
                  <p>
                    <b>Get Template API –</b>
                    When triggered, with the validation of the request the
                    merchant receives template number and name in response as
                    per the templates created by the merchant.
                  </p>
                  <p>
                    <b>Get Template Details API –</b>
                    When triggered, with the validation of the request the
                    merchant receives all details pertaining to the specific
                    template for which the API is triggered.
                  </p>
                  <p>
                    <b>Create Payment Link API –</b>
                    The Create Payment Link API is triggered in order to create
                    invoice using a predefined template in the merchant console
                    by the merchant which is sent along with the payment link.
                  </p>
                  <p>
                    <b>Resend Payment Link API –</b>
                    The merchant hits this API in order to resend the payment
                    link and invoice to customer.
                  </p>
                  <p>
                    <b>Cancel Payment Link API –</b>
                    The merchant hits this API in order to cancel the sent
                    invoice by restricting the ability to make payment using the
                    payment link.
                  </p>
                  <h4>API Info:</h4>
                  <p>
                  ...
                  <div className="d-flex justify-content-end">
                    <a
                      href="/pdf/API/Integration Guides/Invoice Payment Link API/Link Based Payment API V1.2.pdf"
                      className="btn_style1"
                      download={"Link Based Payment API V1.2.pdf"}
                    >
                      Download
                    </a>
                  </div>
                ...
                >
                  ...
                  <h4>Overview: </h4>
                  <p>
                    Bank Account Verification API allows you to verify the bank
                    account swiftly and efficiently, ensuring that the
                    customer’s bank account is active, and the details are
                    accurate.
                  </p>
                  <h4> Key Features:</h4>
                  <p>
                    1. Reduced risk of payment failures and fraudulent
                    transactions
                  </p>
                  <p>
                    2. Comprehensive report accessible using the console
                    entailing detailed information.
                  </p>
                  <p>
                    3. Callback gets triggered for three times if the API
                    response code to NDPS is 200.
                  </p>
                  <h4>API Info:</h4>
                  <p>
                    API Type: REST<br></br>
                  ...
                  <div className="d-flex justify-content-end">
                    <a
                      href="/pdf/API/Integration Guides/Penny Drop (Bank Account Verification) API/Penny Drop API.zip"
                      className="btn_style1"
                      download={"Penny Drop API.zip"}
                    >
                      Download
                    </a>
                  </div>
                ...
                >
                  ...
                  <p>
                    ...
                    Transaction API facilitates the payment process from the
                    initiation of the transaction to the authorization of the
                    payment by the customer on the payment page or seamlessly
                    and provide the transaction API response.
                  </p>
                  <h4> Key Features:</h4>
                  <p>
                    1. Single transaction can be settled to multiple accounts
                    using multi-Product approach
                  </p>
                  <p>
                    2. The customer account can be verified for each payment
                    made via Net Banking and UPI (Use Case : Broker
                    Transactions)
                  </p>
                  <p>
                    3. Precise mode of payment can be executed to be displayed
                    on payment page
                  </p>
                  <p>
                    4. Transactions can be processed directly without
                    redirection to NTT’s payment page (Only for PCI-DSS
                    compliant institutions)
                  </p>
                  <p>
                    5. Multiple attempts to retry the payment post payment
                    failure while using any payment mode
                  </p>
                  <h4>API Info:</h4>
                  <p>
                    API Type: REST<br></br>
                  ...
                  <div className="d-flex justify-content-end">
                    <a
                      href="/pdf/API/Integration Guides/Single _ Multi Product API/Transaction API (Non-seamless)_V2.0.pdf"
                      className="btn_style1"
                      download={"Transaction API (Non-seamless)_V2.0.pdf"}
                    >
                      Download
                    </a>
                  </div>
                ...
                >
                  ...
                  <p>
                    Designed to integrate seamlessly with various platforms.
                    Payout API enables the Merchant to make payments securely to
                    any vendor or service provider’s bank account.{" "}
                  </p>
                  ...
                  <p>
                    3. Real-time notification and comprehensive reports are
                    available to view and download via dashboard.
                  </p>
                  <h4>API Info:</h4>
                  <p>
                    API Type: REST<br></br>
                  ...
                  <div className="d-flex justify-content-end">
                    <a
                      href="/pdf/API/Integration Guides/Vendor Payment API/Vendor Payouts.zip"
                      className="btn_style1"
                      download={"Vendor Payment API.zip"}
                    >
                      Download
                    </a>
                  </div>
                ...
                >
                  ...
                  <h4>Overview: </h4>
                  <p>
                    Settlement Account Add/Update API allows you to verify the
                    bank account swiftly and efficiently, ensuring you that the
                    customer’s bank account is active, and the details are
                    accurate.{" "}
                  </p>
                  <h4> Key Features:</h4>
                  <p>
                    1. Callback gets triggered for three times if the API
                    response code to NDPS is 200.
                  </p>
                  <h4>API's: </h4>
                  <p>
                    <b>Settlement Account Add/Update API</b>
                    <br></br>
                    This API is used to Add new settlement Bank Account for an
                    Account ID or to Update the existing Account Number assigned
                    against said MID
                  </p>
                  <p>
                    <b>Account ID Status Request</b>
                    <br></br>This API will be used to retrieve Account
                    Information from NDPS System post the Add/Update Request
                  </p>
                  <p>
                    <b>Callback API</b>
                    <br></br>It will be triggered once Bank Account is onboarded
                    and will provide information on change of status
                  </p>
                  <h4>API Info:</h4>
                  <p>
                    API Type: REST<br></br>
                  ...
                  <div className="d-flex justify-content-end">
                    <a
                      href="/pdf/API/Integration Guides/Settlement Account Add Update API/Settlement Account Add Update APIs_V1.0.pdf"
                      className="btn_style1"
                      download={"Settlement Account Add Update API.pdf"}
                    >
                      Download
                    </a>
                  </div>
