...
export default function mGalla() {
  return (
    <div className="product-payment pd-lr-15">
      <Head>
        <title>
          Best POS card swipe machine providers in India | POS machine Companies
          in India
        </title>
        <meta
          name="description"
          content="Are you Looking for the best POS machine in India? Look no further. With NTT DATA Payment Services India, accept credit and debit card payments with card swipe POS machines for your business, in-store or on the go."
        />
        <link
          rel="canonical"
          href="https://www.nttdatapay.com/swipecard-pos-machine"
        />
        <script
      ...
      <div className="bnr-home-wrp product-pos-bnr">
        <div className="container_1300">
          <div className="bnr-caption">
            ...
            <p>
              Boost your sales and collect card payments with NTT DATA
              Payments-one of the top POS machine providers in India.{" "}
            </p>
            <Link href="/sign-up">
      ...
      <div className="powerful-gateway">
        <div className="container_1300 d-block">
          <h2 className="common-ttle text-center">
            Our diverse range of Point of Service card swipe machines offers
            tailored solutions to small, medium, and large business enterprises
          </h2>
          <p className="common-desc text-center">
            As providers of the best card swipe machine in India, we’re at your
            service to deliver POS solutions that seamlessly integrate with your
            billing system, delivering a unified experience of unmatched
            efficacy and helping you serve your customers quicker and better.
          </p>

          <div className="product-cnt-pic text-center">
            <img
              src="/images/m-pos-first-fold.svg"
              alt="best-card-swipe-machine-in-india"
              className="img-fluid"
            />
          </div>
        </div>
            ...
            <div className="col-md-6">
              <div className="tmw-lhs">
                <h3 className="common-ttle">
                  A multi-terminal support approach to escalate your business
                </h3>
              ...
              <div className="tmw-rhs">
                ...
                >
                  <SwiperSlide className="tmw-slide-cvr card_style4">
                    <img
                      className="img-fluid"
                      src="/images/pos-grid-1.jpg"
                      alt="best-pos-machine-in-india"
                    />
                    <div className="desc-card">
                      <h4>PSTN POS</h4>
                      <p>
                        Perfect for a traditional retail business with a cashier
                        at the checkout point, the PSTN POS terminals provide
                        real-time communication of payments.
                      </p>
                  ...
                  <SwiperSlide className="tmw-slide-cvr card_style4">
                    <img
                      className="img-fluid"
                      src="/images/pos-grid-2.jpg"
                      alt="best-swipe-machine-in-india"
                    />
                    <div className="desc-card">
                      <h4>GPRS POS</h4>
                      <p>
                        A simple, secured, and accessible option, NTT DATA
                        Payments’ GPRS POS Machine functions through a SIM card
                        to enable wireless payments.
                      </p>
                      {/* <a href="" className="btn_style4">Know More</a> */}
                    </div>
                  </SwiperSlide>
                  <SwiperSlide className="tmw-slide-cvr card_style4">
                    <img
                      className="img-fluid"
                      src="/images/pos-grid-3.jpg"
                      alt=""
                    />
                    <div className="desc-card">
                      <h4>Wi-Fi POS</h4>
                      <p>
                        A robust yet convenient device, NTT DATA Payments Wi-Fi
                        POS equips any business to accept card payments over a
                        smooth Wi-Fi network with just one tap!
                      </p>
                      {/* <a href="" className="btn_style4">Know More</a> */}
                    </div>
                  </SwiperSlide>
                  <SwiperSlide className="tmw-slide-cvr card_style4">
                    <img
                      className="img-fluid"
                      src="/images/pos-grid-4.jpg"
                      alt=""
                    />
                    <div className="desc-card">
                      <h4>Android POS</h4>
                      <p>
                        Optimize performance, productivity and security with
                        best-in-class digital experience for your in-store
                        payment acceptance over Debit and Credit Cards,
                        Contactless cards and QR code.{" "}
                      </p>
                      {/* <a href="" className="btn_style4">Know More</a> */}
                    </div>
                  </SwiperSlide>
                  <SwiperSlide className="tmw-slide-cvr card_style4">
                    <img
                      className="img-fluid"
                      src="/images/pos-grid-5.jpg"
                      alt=""
                    />
                    <div className="desc-card">
                      <h4>mPOS</h4>
                      <p>
                        As one of the best POS machine companies in India, NTT
                        DATA Payments’ mPOS device offers an affordable and
                        seamless option to receive card payments on the go.
                      </p>
                      {/* <a href="" className="btn_style4">Know More</a> */}
                    </div>
                  </SwiperSlide>
      ...
      <div className="product-feature-wrp">
        <div className="container_1300 d-block">
          <h2 className="common-ttle white-clr text-center">
            Elevate your card payment acceptance experience with NTT DATA
            Payments
          </h2>
            ...
            <div className="row">
              <div className="col-md-4">
                <div className="feat-card">
                  <img
                    src="/images/pos-icn1.svg"
                    alt=""
                    className="img-fluid"
                  />
                  <p className="ttle">One of the best in the industry</p>
                  <p className="desc">
                    Providing the best card swipe machine in India for decades,
                    NTT DATA Payments service millions of merchants including
                    Big Bazar, Lifestyle, Shoppers Stop, etc.
                  </p>
                </div>
              </div>
              <div className="col-md-4">
                <div className="feat-card">
                  <img
                    src="/images/pos-icn2.svg"
                    alt=""
                    className="img-fluid"
                  />
                  <p className="ttle">Tailor-made for every business</p>
                  <p className="desc">
                    Your business is unique, and so should your payment
                    solutions be. We understand your business needs and help you
                    choose the best card payment acceptance experience.
                  </p>
                </div>
              </div>
              <div className="col-md-4">
                <div className="feat-card">
                  <img
                    src="/images/pos-icn3.svg"
                    alt=""
                    className="img-fluid"
                  />
                  <p className="ttle">Easy Onboarding</p>
                  <p className="desc">
                    48 hours - that’s all the time we need to process your
                    request and deliver the best POS machine in India to you!
                  </p>
                </div>
              </div>
              ...
              <div className="col-md-4">
                <div className="feat-card">
                  <img
                    src="/images/pos-icn4.svg"
                    alt=""
                    className="img-fluid"
                  />
                  <p className="ttle">Power of EMI</p>
                  <p className="desc">
                    NTT DATA Payments’ multi-bank credit card EMI solution helps
                    you sell high valued commodities through easy monthly
                    installments.{" "}
                  </p>
                </div>
              </div>
              ...
              <div className="col-md-4">
                <div className="feat-card">
                  <img
                    src="/images/pos-icn5.svg"
                    alt=""
                    className="img-fluid"
                  />
                  <p className="ttle">Affordable Pricing</p>
                  <p className="desc">
                    Our payments solution requires a minimal initial investment
      ...
      <div className="explore-other-wrp exp-wrp mob-text-center">
        <div className="container_1300 d-block">
          <div className="row">
            <div className="col-md-6">
              <h3 className="common-ttle">
                Ready to deploy POS Solutions for Banks, Acquirers and Payment
                Facilitators
              </h3>
              <p className="common-desc">
                With NTT DATA Payments, open the doors to growth and development
                with an end-to-end solution, leading to swift customer
                acquisition and open new streams of revenue. Our ready to deploy
                POS helps meet the digital demands and offers several
                value-added services to suit your comprehensive merchant base.{" "}
              </p>
            </div>
            ...
            <div className="col-md-5">
              <h3 className="common-ttle ">
                Open new avenues to a recurring income{" "}
              </h3>
              <p className="common-desc">
                Become an NTT DATA Payments POS Reseller. Help us in making our
                business more profitable and earn generous income by becoming an
                NTT DATA Payments POS device reseller in return.
              </p>
              {/* <a href="" className="btn_style_white">Sign up</a> */}

              <p className="common-desc  mt-30">
                <strong>What will the reseller earn?</strong>
              </p>
              {/* <a href="" className="btn_style_white">Sign up</a> */}
              <ol>
                <li>10-15% of the POS installation commission.</li>
                <li>
                  A regular income of the difference in markup rate over base
                  rate on Credit and Debit Cards.
                </li>
              </ol>
              <Link href="/sign-up">
                <a href="" className="btn_style1">
            ...
            <div className="col-md-12">
              <div className="boost-lhs-wrp">
                <h2 className="common-ttle">
                  Why NTT DATA Payments POS Machine is your ultimate tool for
                  growth
                </h2>
                      ...
                      <div className="row">
                        <div className="col-md-4">
                          <div className="boost-card">
                            <img
                              src="/images/pos-icn6.svg"
                              alt=""
                              className="img-fluid"
                            />
                            <h3>Quick Settlement</h3>
                            <p>
                              As one of the best POS machine companies in India,
                              we offer a swift and automatic settlement process
                              to ensure your earnings reflect in your bank
                        ...
                        <div className="col-md-4">
                          <div className="boost-card">
                            <img
                              src="/images/pos-icn7.svg"
                              alt=""
                              className="img-fluid"
                            />
                            <h3>Secured Transactions</h3>
                            <p>
                              Your security is our top most priority. NTT DATA
                              Payments promotes bank-level security with PCI DSS
                              3.2.1v compliance and 256-bit encryption.
                            </p>
                          </div>
                        </div>
                        <div className="col-md-4">
                          <div className="boost-card">
                            <img
                              src="/images/pos-icn8.svg"
                              alt=""
                              className="img-fluid"
                            />
                            <h3>
                              Comprehensive Dashboard to Monitor Transactions
                            </h3>
                            <p>
                              Monitor real-time payments, along with refunds,
                              chargebacks and settlement with our robust
                              merchant console.{" "}
                            </p>
                          </div>
                        </div>
                        <div className="col-md-4">
                          <div className="boost-card">
                            <img
                              src="/images/pos-icn9.svg"
                              alt=""
                              className="img-fluid"
                            />
                            <h3>Accept all Major Debit and Credit Cards</h3>
                            <p>
                              As the providers of the best POS machine in India,
                        ...
                        <div className="col-md-4">
                          <div className="boost-card">
                            <img
                              src="/images/pos-icn10.svg"
                              alt=""
                              className="img-fluid"
                            />
                            <h3>Centralized Help Desk</h3>
                            <p>
                              Round the clock service to make sure your concerns
                              and queries never go unaddressed.{" "}
                            </p>
                          </div>
                        </div>
                      </div>
      ...
      <div className="explore-other-wrp exp-wrp">
        <div className="container_1300 d-block">
          <div className="row">
            <div className="col-md-12">
              <h2 className="common-ttle text-center">
                Customizable card payment acceptance solutions across businesses
              </h2>
              <p className="common-desc  pb-20 text-center">
                Big, small, or medium- our POS solutions are made to fit all
                your card payment acceptance needs.{" "}
              </p>
              <div className="boost-sldr-wrp">
                <Swiper
                  // modules={[Pagination]}
              ...
              <p className="common-desc text-center">
                <strong>
                  Don’t wait to accept card payments. Get your NTT DATA Payments
                  POS within 48 hours!
                </strong>
              </p>
              ...
              <div className="faq-rhs">
                <div className="accordion" id="accordionExample3">
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                        A POS machine is a terminal that enables you to collect
                        payments from your customers through credit and debit
                        cards in store or on the go.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                        Get NTT DATA Payments’ tailor-made top swipe machine in
                        India for your business within 48 hours by signing up on
                        our website.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="accordion-item">
                    <p className="accordion-header" id="headingOne3">
                      ...
                      >
                        Is accepting card payments through the POS terminal
                        safe?
                      </button>
                    </p>
                    <div
                    ...
                    >
                      <div className="accordion-body">
                        Yes, our bulletproof online security is backed with PCI
                        DSS v 3.2.1 compliance and 256-bit encryption, ensuring
                        a safe transaction. With NTT DATA Payments- one of the
                        best POS machine providers in India, be a part of our
                        comprehensive retailer family.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                        NTT DATA Payments provides basic operational and
                        technical training to the merchants to use the best POS
                        machine in India.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                        NTT DATA Payments provides myriad Card Swipe payment
                        solutions made to suit your business’s needs. This
                        includes PSTN POS, GPRS POS, WiFi, Android and mPOS.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                        Usually, we levy a minimum amount of Rs.1500 as an
                        enrolment fee for the top swipe machine in India, but
                        currently, it is FREE! So, order yours now!
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                        As one of the best POS machine companies in India, we
                        have no service charge and AMC for the initial 2 years.
                        After two years, we levy a certain percentage for
                  ...
                  <div className="accordion-item">
                    <p className="accordion-header" id="headingOne9">
                      ...
                      >
                        In how many days will I receive the payment in my
                        account?
                      </button>
                    </p>
                    <div
                    ...
                    >
                      <div className="accordion-body">
                        We work on a T+1 cycle on crediting the amount back to
                        your account, where T refers to the date of the
                        transaction followed by 1 working day.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                        Yes, you can link our top swipe machine in India with
...
<a href="">Know More</a>
              ...
              <div className="col-md-3">
                <div className="explore-card explore4">
                  ...
                  <p>
                    Open doors to great sales with the best payment experience
                    for your customers.
                  </p>
