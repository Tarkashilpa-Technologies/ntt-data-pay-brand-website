                                      ...
                                      <Dropdown.Item>
                                        <div
                                          ...
                                          onClick={() => {
                                            ...
                                            router.push(
                                              `/integration-guide/${tutorial?.attributes?.Title.toLowerCase().replace(
                                                /\s+/g,
                                                '-'
                                              )}`
                                            )
            ...
            <div style={{ flex: 1 }}>
              <div className='d-flex d-flex w-100 h-100'>
                        ...
                        return (
                          <div key={index}>
                            ...
                            >
                              ...
                              <Accordion.Body
                                className='m-0 p-0 py-2 ps-2 pb-3 ms-4'
                ...
                <div className='p-xl-5 pt-xl-0 pt-lg-0 p-md-3 mt-5 h-100 w-lg-50 w-100'>
                  <div
                    className='shadow p-xl-5 middle-section-shadow'
                            ...
                            {tutorialData?.tutorials?.data?.map(
                              (tutorial, index) => {
                                return (
                                  <div className='p-1'>
                                    <a
                                      href={`/integration-guide?data=${tutorial?.attributes?.Title.replace(
                                        /\s+/g,
                                        ''
                                      )}&id=`}
