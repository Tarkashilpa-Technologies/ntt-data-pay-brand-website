          ...
          <form onSubmit={handleSubmit}>
            <div className="row">
              ...
              <div className="col-md-12 mb-10">
                <button
                  type="submit"
                  className="btn btn-primary btn_style1 mb-3 mt-3"
                >
                  Sign Up
                </button>
                &nbsp;&nbsp;
                <span className="thankyou-message" id="tymessage">
          ...
          <div className="row">
            <div className="col-md-6">
              <div className="elevate-lhs">
                <h2 className="common-ttle">
                  Start the journey to your growth with us today!
                </h2>
                <p className="common-desc white-clr">
                  More than 6 million merchants trust <br />
                  NTT DATA Payment Services for payment solutions for their
                  business.{" "}
                </p>
