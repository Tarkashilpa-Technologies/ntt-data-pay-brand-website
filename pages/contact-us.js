  ...
  return (
    <div className="contactpage">
      <Head>
        ...
        <meta name="description" content="NTT DATA Payment Services India is a leading omnichannel payment service provider in India. With round the clock, uninterrupted support, our customer care executives are always here to assist you." />
     </Head>
...
<p className="common-desc">Get your issues resolved quickly. Raise a request and we&#39;ll be at your service!</p>
 </div>    
 </div>
...
<div className="row">
  ...
  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3769.8725405609594!2d72.86446121485884!3d19.11324675576758!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c8320052c6a1%3A0x9d0dd5983851795e!2sAtom%20Technologies%20Ltd.!5e0!3m2!1sen!2sin!4v1647864839487!5m2!1sen!2sin" width="100%" height="510" style={{ border: 0 }} allowFullScreen="" loading="lazy"></iframe>  
    </div>    
  </div>  
  ...
  <div className="accordion-item">
    ...
    <div id="flush-collapseOne" className="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
      <div className="accordion-body">
        ...
        <p className="contact-addr">Northern Alliance Tours & Leisure Private Limited<br/>403-A, 4th Floor, M-3, AVG Bhawan,<br/> M-Block, Middle Circle Connaught Place,<br/> NEW DELHI - 110001</p>
...
<p className="contact-addr">SKAV 909, AWFIS,<br/> 14th Floor, Lavelle Road,<br/> 
Richmond Circle,<br/> Bengaluru</p>
...
<p className="contact-addr">C/O AWFIS, 5th Floor,<br/>50 Chowringhee Road,<br/>Kolkata 700071,<br/>West Bengal, India</p>
...
<p className="contact-addr">Awfis Space Solutions,<br/> E Floor, Taj Deccan Hotel,<br/> Road Number 1, Banjara Hills, <br/>Hyderabad, Telangana 500034</p>
...
<p className="contact-addr">Hallmark Towers,<br/>
8th Floor, TS No : 13,<br/> Block No : 5 , Plot No : 35,<br/> Thiru vi ka Industrial Estate, Guindy<br/> Chennai - 600032</p>
