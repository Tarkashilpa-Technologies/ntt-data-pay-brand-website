...
export default function Header() {
  ...
  return (
    ...
    cursor: pointer;
      ...
      <div id="overlay">
        {" "}
        <div id="agm-close">X</div>
      </div>
      <div id="overlay2">
        {" "}
        <div id="annual-close">X</div>
      </div>
      <div id="agm_form">
      ...
      <div className="container_1300">
        ...
        {router.pathname == "/campaign-page" ? (
          ...
          <div className="menubox-div">
            <ul className="menubox" ref={menubox}>
              <li
                className={`${styles.dropdown} ${router.pathname == "/about-us" ? "active" : ""}`}
              >
                <Link href="/about-us">
                  <a onClick={handleMenuClick} className={styles.dropbtn}>
                    About
              ...
              <li className={styles.dropdown}>
                ...
                <div
                  className={`${styles.dropdown_content} ${router.pathname == "/online-payment-gateway-india" ? "active" : ""}`}
                >
          ...
          <a  onClick={handleMenuClick} className={styles.dropbtn}>
            Developers
              ...
              <li className={styles.dropdown}>
                ...
                <div
                  className={`${styles.dropdown_content} ${router.pathname == "/payment-solutions-for-retail-industry" ? "active" : ""}`}
                >
              ...
              <li className={styles.dropdown}>
                ...
                <div
                  className={`${styles.dropdown_content} ${router.pathname == "" ? "active" : ""}`}
                >
              ...
              <li className={styles.dropdown}>
                ...
                <div
                  className={`${styles.dropdown_content} ${router.pathname == "/blog" ? "active" : ""}`}
                >
                  <Link href="/developer-guide">
                    <a onClick={handleMenuClick}>Developers</a>
                  </Link>

                  <Link href="/customer-care">
                    <a onClick={handleMenuClick}>Get Help</a>
                  </Link>

                  <Link href="/white-paper">
                    <a onClick={handleMenuClick}>White Paper</a>
                  </Link>

                  {/*  <Link href="/blog"> */}
                  <a
                    href="https://www.nttdatapay.com/blog"
                    target="_blank"
