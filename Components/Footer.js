  ...
  return (
    <div className={styles.footer}>
      <div className="container_1300 d-block">
        {router.pathname == "/campaign-page" ? (
          <div className="row justify-content-center">
            <div className="col col-md-3 text-center">
              <div className={styles.ftrcard1}>
                <a href="" className={styles.ftrlogo}>
                  <img
                    src="/images/ntt-footer-logo.svg"
                    alt=""
                    className="img-fluid"
                  />
                </a>
                <a className={styles.ftrtele} tel="9152035710">
                  <span>Call Us : </span>+91 9152 0357 10
                </a>
              </div>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col col-md-3">
              <div className={styles.ftrcard1}>
                ...
                <a className={styles.ftrtele} tel="18602664959">
                  <span>Helpdesk : </span> 1860 266 4959
                </a>
                <a className={styles.ftrtele} tel="+91 9152035710">
                  <span>Sales : </span> +91 9152035710
                </a>
              </div>
            </div>
   ...
   <a href="" className={styles.ftrlnks}>Investors</a> */}
            ...
            <div className="col col-md-2 col-6">
              <div className={styles.ftlnkscvr}>
                ...
                <Link href="/csr-policy">
                  <a className={styles.ftrlnks}>CSR Policy</a>
                </Link>
            ...
            <div className="col col-md-2 col-6">
              <div className={styles.ftlnkscvr}>
                ...
                <Link href="javascript:void(0)">
                  <a className={styles.ftrlnks} id="foo">
                    AGM Video
                  </a>
                </Link>

                <Link href="javascript:void(0)">
                  <a className={styles.ftrlnks} id="annual">
                    Annual Report
                  </a>
                </Link>
              </div>
            ...
            <div className="col col-md-2">
              <div className={styles.ftlnkscvr}></div>
            </div>
          </div>
        )}
      </div>
          ...
          <div className="row">
            ...
            <div className="col-md-5">
              <div className={styles.socialftrcvr}>
                <a
                  href="https://www.facebook.com/nttdatapayments"
                ...
                <a
                  href="https://twitter.com/nttdatapayments"
                  rel="noopener noreferrer"
                  target="_blank"
                >
                  <img src="/images/twitter.svg" alt="" className="img-fluid" />
                </a>
                <a
                  href="https://www.linkedin.com/company/ntt-data-payments"
                  rel="noopener noreferrer"
                  target="_blank"
                >
                  <img
                ...
                <a
                  href="https://www.instagram.com/nttdatapayments/"
                  rel="noopener noreferrer"
                  target="_blank"
                >
                  <img
                ...
                <a
                  href="https://www.youtube.com/c/NTTDATAPaymentServicesIndia"
                  rel="noopener noreferrer"
                  target="_blank"
                >
                  <img src="/images/youtube.svg" alt="" className="img-fluid" />
                </a>
